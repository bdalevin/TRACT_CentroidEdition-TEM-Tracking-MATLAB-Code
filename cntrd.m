...
for i=1:nmx
    ...
    if norm==0 % If the norm of the centroid is zero, the centroid position defaults to the middle of the window.
        xavg = r;
        yavg = r;
        rg=0;
        else
    ...
    %concatenate it up
    pts=[pts,[mx(i,1)+xavg-r,mx(i,2)+yavg-r,norm,rg,ID(i)]'];
