function plot_centrdpositions(series, cent)
...
% 
    ...
    scatter(cent(:,1,imnum),cent(:,2,imnum),500,'x','c');  % Scatter plot the peaks found for the first image on top of the fist image
    brush on;
    ...
    key = 'default';
        while( key ~= 'q' )
            ...
            if key == 'p'
                ...
                scatter(cent(:,1,imnum),cent(:,2,imnum),500,'x','c');
                brush on;
